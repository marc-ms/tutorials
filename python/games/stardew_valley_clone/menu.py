...
class Menu:
    ...
    def display_money(self):
        ...
        pygame.draw.rect(self.display_surface, 'White', text_rect.inflate(10, 10), 0, 4) # los ultimos argumentos son para redondear el rectangulo
